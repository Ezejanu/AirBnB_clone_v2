...
class HBNBCommand(cmd.Cmd):
    ...
    def do_create(self, args):
        ...
        # Create an empty dictionary to store parsed parameters
        parsed_params = {}

        # Regular expression patterns for matching key-value pairs
        string_pattern = r'\"(..*?)\"'
        float_pattern = r'\d+\.\d+'
        int_pattern = r'\d+'
        ...
        for parameter in parameters:
            ...
            if re.match(string_pattern, value):
                parsed_value = re.search(string_pattern, value).group(1).replace('_', ' ')
